...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/scl-generator/src/main/java");
        gc.setAuthor("ljm"); //作者
        ...
        dsc.setPassword("164411");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        pc.setParent("com.ljm.generator")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/scl-generator/src/main/resources/mapper/" + pc.getModuleName()
