/* 数据管理 */
const Table = () => import('@/pages/table-manage')
const TableList = () => import('@/pages/table-manage/table-list')

/* 接口管理 */
const Api = () => import('@/pages/api-manage')
const ApiList = () => import('@/pages/api-manage/api-list')
